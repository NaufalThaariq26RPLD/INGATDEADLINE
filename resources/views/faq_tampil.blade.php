                  ...
                  <div>
                    <form action="/faqupdate/{{ $data->id }}" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="pertanyaan" id="pertanyaan" cols="30" rows="4">{{ $data->pertanyaan }}</textarea>
                      </div>
                      <div class="form-group" style="margin-top: 5px; margin-bottom: 10px">
                        <label for="Answer">Answer</label>
                        <textarea class="form-control" name="answer" id="answer" cols="30" rows="4">{{ $data->answer }}</textarea>
                      </div>
