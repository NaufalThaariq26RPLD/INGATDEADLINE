@include('partial.sidebar-navbar')
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Update Data SuperAdmin</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
          <li class="breadcrumb-item">Data Super Admin</li>
          <li class="breadcrumb-item active">Update Data Super Admin</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="/updatesuper/{{ $data->id }}" method="post" enctype="multipart/form-data">
                @csrf
