      ...
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="/inserttoko" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Toko</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama_toko" id="nama_toko" placeholder="Nama Toko" value="{{ old('nama_toko') }}">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="link_website" id="link_website" placeholder="Link Website Toko" value="{{ old('link_website') }}">
                    </div>
                  </div>
