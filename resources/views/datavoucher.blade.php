...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Data Voucher Dikonfirmasi</h1>
        <nav>
            <ol class="breadcrumb">
                                        ...
                                        <table class="table table-borderless datatable">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $row)
                                                    <tr>
                                                        <th scope="col">{{ ++$no }}</th>
                                                        <td> <div class="image-container"><img class="image" src="{{ asset('gambarvoucher/' . $row->gambar) }}" style="width: 100px; object-fit: cover"></div></td>
                                                        ...
                                                        <td><a href="/tampildata/{{ $row->id }}"
                                                                class="btn btn-info mb-2"><i
                                                                    class="bi bi-pencil-square "></i> Edit</a><br>
