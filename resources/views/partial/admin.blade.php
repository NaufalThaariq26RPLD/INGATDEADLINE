...
<head>
    ...
    <link href="{{ asset('logotoko/' .Auth::user()->tokos->logo) }}" rel="apple-touch-icon">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <a href="/laris">
              <i class="bi bi-circle"></i><span>Voucher Laris</span>
                    ...
                    <li>
                        <a href="/panding">
                            <i class="bi bi-circle"></i><span>Data Voucher Menunggu</span>
                        </a>
                    </li>
                    <li>
                        <a href="/tolakvoucher">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/kategoritoko">
