                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/editsuper/{{ $table->id }}" type="button" class="btn btn-success"><i class="bi bi-pencil"></i> Edit Data</a><br><a href="/deletesuper/{{ $table->id }}" type="button" class="btn btn-danger mt-2"><i class="bi bi-x-lg"></i> Hapus Data</a></td>
                          </tr>
                        @endforeach
