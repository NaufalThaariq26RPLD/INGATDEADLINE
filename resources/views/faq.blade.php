                ...
                @foreach ($data as $data)
                    ...
                    <div class="alert alert-info" role="alert" style="display: flex; justify-content: space-between; position: relative; gap: 0px 10px" >
                      ...
                      <a href="/faqtampil/{{ $data->id }}" class="alert-link" style="font-weight:bold; color: black; margin-left: auto; display: inline-block; margin-top: auto; margin-bottom: auto; width: 10%; float: right">Balas
                        ...
                        <a style="font-weight:bold; color: black;  display: inline-block; margin-top: auto; margin-bottom: auto; width: 10%; float: right" class="alert-link" href="/faqdelete/{{ $data->id }}">
              ...
              <div class="card recent-sales overflow-auto">
                ...
                @foreach ($data2 as $datas)
                    ...
                    <div class="alert alert-info" role="alert" style="display: flex; justify-content: space-between; position: relative; gap: 0px 10px">
                      ...
                      <h1 style="font-size: 12px; font-weight: bold">Jawaban : {{ $datas->answer }}</h1>
                    </div>

                    <a href="/faqupdates/{{ $datas->id }}" class="alert-link" style="font-weight:bold; color: black; margin-left: auto; display: inline-block; margin-top: auto; margin-bottom: auto; width: 10%; float: right">Update
                        <i class="bi bi-pencil-square"></i><a style="font-weight:bold; color: black; display: inline-block; margin-top: auto; margin-bottom: auto; width: 10%; float: right" class="alert-link" href="/faqdelete/{{ $datas->id }}">
                        <i class="bi bi-x-lg"></i> Hapus
                    </a>
